...
int main() {
    ...
    for (int i = 0; i < originalList.numPeople; ++i) {
        std::cout << "Person : " << originalList.people[i].name << ", " << originalList.people[i].age << std::endl;
    }
    
    std::cout << "\nCopied List:" << std::endl;
    for (int i = 0; i < copiedList.numPeople; ++i) {
        std::cout << "Person : " << copiedList.people[i].name << ", " << copiedList.people[i].age << std::endl;
    }
